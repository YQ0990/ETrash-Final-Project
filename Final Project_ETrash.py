...
mainwindow = Tk()
mainwindow.title("ETrash")
# Creating frame
frame1 = Frame(mainwindow)
frame1.grid(rowspan=10, columnspan=10)

image = ImageTk.PhotoImage(Image.open("image1.jpg"))
logo = Label(frame1, image=image)
logo.grid(pady=20, padx=3)

# create frame 2
frame2 = Frame(mainwindow)
frame2.grid(rowspan=10, columnspan=10)

picture = ImageTk.PhotoImage(Image.open("image2.png"))
log = Label(frame2, image=picture)
log.grid(pady=20, padx=3, row=5, column=1)
